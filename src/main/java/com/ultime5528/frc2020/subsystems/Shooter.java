...
public class Shooter extends SubsystemBase implements Loggable {
  ...
  public static final SparkMaxConfig kMotorConfig = new SparkMaxConfig(IdleMode.kCoast, 0.1, 40, 60);
  ...
  private LinearInterpolator interpolator = new LinearInterpolator(new Point[] { new Point(0.074, 3250), new Point(0.077, 3100),
      new Point(0.082, 2900), new Point(0.0916, 2600), new Point(0.0958, 2500), new Point(0.1, 2500),
      new Point(0.105, 2500), new Point(0.11, 2450), new Point(0.116, 2350), new Point(0.12, 2325),
  ...
  public double tirer(OptionalDouble optHauteur) {
    ...
    if (Constants.ENABLE_CAN_SHOOTER) {
      if (Constants.ENABLE_VISION && optHauteur.isPresent()) {
        ...
        vitesse = interpolator.interpolate(hauteur) * (hauteur <= .106 ? 1.125 : 1.08);
      } 
